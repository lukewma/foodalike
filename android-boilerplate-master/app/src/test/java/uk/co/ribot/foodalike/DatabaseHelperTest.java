...
import uk.co.ribot.foodalike.data.local.Db;
import uk.co.ribot.foodalike.data.local.DbOpenHelper;
import uk.co.ribot.foodalike.data.model.Ribot;
import uk.co.ribot.foodalike.test.common.TestDataFactory;
import uk.co.ribot.foodalike.util.DefaultConfig;
import uk.co.ribot.foodalike.util.RxSchedulersOverrideRule;
